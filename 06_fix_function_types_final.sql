-- Step 6: Fix Function Return Types - Final Fix
-- Run this to fix the remaining type mismatch error
...
-- Recreate with ALL correct types matching the actual database schema
