  ...
  <div className="flex gap-px">
    {[1, 2, 3, 4, 5].map((star) => (
      <button
        ...
        style={{
          ...COMPONENT_STYLES.forms.addDish.starRatingButton,
          color: star <= rating ? DESIGN_TOKENS.colors.primary : DESIGN_TOKENS.colors.ratingEmpty,
        }}
      ...
      {!show ? (
        <div className="flex justify-center w-full">
          <button
            ...
            style={COMPONENT_STYLES.forms.addDish.toggleButton}
          >
            + Add New Dish
          </button>
        </div>
        ...
        <div className="space-y-4 w-full max-w-full">
          <div className="flex justify-center w-full px-2">
            <input
              ...
              style={COMPONENT_STYLES.forms.addDish.input}
              autoFocus
              onKeyPress={(e) => {
          ...
          <div className="flex flex-col items-center gap-1">
            <p className="text-sm mb-0.5" style={COMPONENT_STYLES.forms.addDish.ratingLabel}>
              Rate this dish:
            </p>
          ...
          <div className="flex justify-center gap-3 w-full max-w-full">
            <button
              ...
              style={{
                ...COMPONENT_STYLES.forms.addDish.submitButton,
                backgroundColor: !dishName.trim() ? DESIGN_TOKENS.colors.gray300 : DESIGN_TOKENS.colors.primary,
              }}
            >
              Add Dish
            </button>
            ...
            <button
              ...
              style={COMPONENT_STYLES.forms.addDish.cancelButton}
            >
              Cancel
            </button>
          </div>
