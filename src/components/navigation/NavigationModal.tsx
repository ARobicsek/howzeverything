...
const NavigationModal: React.FC<NavigationModalProps> = ({ isOpen, onClose, isAdmin }) => {
  ...
  const baseMenuItems: MenuItem[] = [
    { to: '/home', label: 'Home', icon: <><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/><path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></>, iconStyle: 'stroke' },
    { to: '/find-restaurant', label: 'Find a Restaurant & Rate Dishes', icon: <><path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7"/><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><path d="M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"/><path d="M2 7h20"/><path d="M22 7v3a2 2 0 0 1-2 2a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 16 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 12 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 8 12a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 4 12a2 2 0 0 1-2-2V7"/></>, iconStyle: 'stroke' },
    ...
    { to: '/ratings', label: 'My Ratings', icon: <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/>, iconStyle: 'stroke' },
    { to: '/profile', label: 'My Profile', icon: <><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></>, iconStyle: 'stroke' },
  ...
  return (
    <div className="fixed inset-0 z-modal-backdrop">
      ...
      />
      <div className="absolute top-0 right-0 bottom-0 w-[min(300px,80vw)] bg-navBarDark shadow-lg flex flex-col p-8 animate-slide-in-right z-modal">
        <button
          onClick={onClose}
        ...
        <nav>
          <ul className="list-none p-0 mt-[76px]">
            {menuItems.map(item => {
              const linkColor = item.adminOnly ? 'text-ratingGold' : 'text-textWhite';
              ...
              return (
                <li key={item.to}>
                  <Link
                    to={item.to}
                    onClick={onClose}
                    className={`flex items-center gap-4 px-2 py-4 no-underline text-2xl font-medium rounded-md transition-colors duration-200 ease-in-out hover:bg-white/10 ${linkColor}`}
                  >
