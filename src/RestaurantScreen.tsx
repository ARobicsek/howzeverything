// src/RestaurantScreen.tsx - Updated with elegant location permission handling    
...
// NEW: Enhanced Location Permission Banner Component
const LocationPermissionBanner: React.FC<{
  ...
  const handleClick = () => {
    if (isPermissionBlocked) {
      // For blocked permissions, show instructions directly instead of trying to request again
      alert(
        "Location access is blocked in your browser settings.\n\n" +
        "To enable location services:\n\n" +
        "📱 On Mobile:\n" +
        "• Tap the location icon (🌐) in your browser's address bar\n" +
          ...
          <p style={{
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                padding: '0',
                cursor: isRequestingPermission ? 'default' : 'pointer',
...
const RestaurantScreen: React.FC<RestaurantScreenProps> = ({    
  ...
  const requestLocationPermission = useCallback(async () => {
    ...
    try {
      ...
      setUserLon(position.coords.longitude);
      setShouldShowLocationBanner(false);
      console.log('📍 User location permission granted:', position.coords.latitude, position.coords.longitude);
